...
export const FileUpload2Informe = (props) => {
...
console.log(desactiva)
  const onChange = (e) => {
    ...
    if (extenxion === "xls" || extenxion === "xlsx")  {
      ...
      swal("Incorrecto", "Tiene que ser en formato Excel", "warning");
  ...
  function handleEnviar(e) {
    ...
    let url = varss.uriUpload + "ainf2_upload.php";
    const options = {
    ...
    .post(url, data, {options,
      ...
      .then((res) => {
        ...
        if (res.status === 200) {
          ...
          let url =
            varss.uri +
            "profe_ainf2.php?rapida=" +            props.rapida +
            "&an=" +
            props.anio +
            "&ca=" +
            props.carrera +
